...
export const loggingMiddleware = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const publicRoutes = [
        ...
        "/api/default-organizations/active",
        "/api/default-organization",
        "/api/default-organizations",
        "/api/hospitals",
        "/api/payments/hospital-configuration",
        "/api/payments/create-order",
        "/api/payments/verify",
        "/api/payments/by-appointment",
        ...
        "/robots.txt",
        "/api/test-sms",
        "/api/clinical-summary/share",
        "/api/patients/registration-link",
        "/api/patients/register",
        "/api/patients/quick-check",
        "/api/patients/next-token",
        "/api/patients/send-registration-link",
        "/api/patients",
        ...
        "/api/default-organizations",
        "/api/appointments/book-from-pulse",
        "/api/v1/mobile/auth/signup-otp",
        "/api/v1/mobile/auth/register",
        "/api/v1/mobile/auth/login",
        "/api/v1/mobile/auth/sendotp",
        "/api/v1/mobile/auth/verify-login",
        "/api/v1/mobile/auth/resend-otp",
