...
appointmentRouter.post("/:id/cancel-whatsapp", appointmentController.sendCancellationWhatsApp.bind(appointmentController));
appointmentRouter.post("/:id/reminder", appointmentController.sendReminder.bind(appointmentController));
