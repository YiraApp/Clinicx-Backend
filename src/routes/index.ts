...
import { defaultOrganizationRouter } from "./Organizations/default-organization.routes.js";
import { hospitalRouter } from "./Organizations/hospital.routes.js";
import { hospitalSettingsRouter } from "./Organizations/hospital-settings.routes.js";
...
import patientSummaryRouter from "./Appointments/patient-summary.routes.js";
import patientDashboardRouter from "./Appointments/patient-dashboard.routes.js";
...
router.use("/hospitals", hospitalSettingsRouter);
...
router.use("/patient-dashboard", patientDashboardRouter);
